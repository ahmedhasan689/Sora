    ...
    <form action="{{ route('user.update',  ['id' => $user->id]) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-4">
                <label>الأسم</label>
                <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" placeholder="أدخل الأسم" name="name" value="{{ $user->name }}">
            </div>
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control @error('phone_number') is-invalid @enderror" id="phone_number" name="phone_number" placeholder="أدخل رقم الجوال" value="{{ $user->phone_number }}">
            </div>
        ...
        <!-- Start Email -->
            <div class="form-group col-md-6">
                <label>الايميل</label>
                <input type="email" class="form-control @error('email') is-invalid @enderror" id="Email" name="email" placeholder="أدخل الايميل" value="{{ $user->email }}">
            </div>
        ...
        <!-- City -->
            <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control @error('city') is-invalid @enderror" id="inputCity" name="city" value="{{ $user->country->city }}">
            </div>
        ...
        <!-- Zip-code -->
            <div class="form-group col-md-2">
                ...
                <input type="text" class="form-control @error('zip_code') is-invalid @enderror" id="inputZip" name="zip_code" value="{{ $user->country->zip_code }}">
            </div>
