...
<form>
    <div class="form-row">
        <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control" id="inputEmail4" placeholder="أدخل الأسم">
        </div>
        <div class="form-group col-md-6">
            <label for="inputPassword4">الايميل</label>
            <input type="email" class="form-control" id="inputPassword4" placeholder="أدخل الايميل">
        </div>
    </div>
    <div class="form-row">
        <div class="form-group col-md-6">
